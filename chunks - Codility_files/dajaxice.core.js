...
var Dajaxice = {
    ...
    update_name: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.campaigns.update_name', 'POST', callback_function, argv, custom_settings);
    },

    invite_candidates: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.campaigns.invite_candidates', 'POST', callback_function, argv, custom_settings);
    },

    deactivate_link: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.campaigns.deactivate_link', 'POST', callback_function, argv, custom_settings);
    },

    set_link: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.campaigns.set_link', 'POST', callback_function, argv, custom_settings);
    },

    toggle_campaign_archive: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.campaigns.toggle_campaign_archive', 'POST', callback_function, argv, custom_settings);
    }
    ...
    tickets_remove: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.tickets.tickets_remove', 'POST', callback_function, argv, custom_settings);
    },

    ticket_change: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.tickets.ticket_change', 'POST', callback_function, argv, custom_settings);
    },

    set_tickets_archive: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.tickets.set_tickets_archive', 'POST', callback_function, argv, custom_settings);
    },

    send_share_link: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.tickets.send_share_link', 'POST', callback_function, argv, custom_settings);
    }
    ...
    resend_invitation: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.dashboards.resend_invitation', 'POST', callback_function, argv, custom_settings);
    }
    ...
    change_user: function(callback_function, argv, custom_settings){
        return Dajaxice.call('codility.backoffice.change_user', 'POST', callback_function, argv, custom_settings);
    }
